 ...
 * Blackboard + Data Pulls + Hydration Status + Risk Curve
 */
...
window.ARK = {
    ...
    refresh: function() {
        ...
        this.hydrationStatus.barchart.timestamp = now;
        this.hydrationStatus.koyfin.timestamp = now;
        this.hydrationStatus.coinglass.timestamp = now;
        this.get('risk_curve');
